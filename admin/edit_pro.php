...
?>
<br><br>
        <form action="" method="post" enctype="multipart/form-data" style="font-family: JF Flat Regular ;">
    ...
    margin-bottom: 31px;
    color: #fff;
    font-size: 30px;">تعديل بيانات المنتج</h2></td>
    </tr>
                <tr>
                    <td align="right"><b>اسم المنتج:</b></td>
                    <td><input type="text" name="product_title" size="60" value="<?php echo $pro_title;?>"/></td>
                </tr>
                <tr>
                    <td align="right"><b>تصنيف المنتج:</b></td>
                    <td>
                ...
                <tr>
                    <td align="right"><b>العلامة التجارية:</b></td>
                    <td>
                ...
                <tr>
                    <td align="right"><b>صورة المنتج:</b></td>
                    <td><input type="file" name="product_image" /><img src="product_images/<?php echo $pro_image; ?>" width="60" height="60"/></td>
                </tr>
                <tr>
                    <td align="right"><b>سعر المنتج:</b></td>
                    <td><input type="text" name="product_price" value="<?php echo $pro_price;?>"/></td>
                </tr>
                <tr>
                    <td align="right"><b>وصف المنتج:</b></td>
                    <td><textarea name="product_desc" cols="50" rows="6"><?php echo $pro_desc;?></textarea></td>
                </tr>
                <tr>
                    <td align="right"><b>الكلمات المفتاحية:</b></td>
                    <td><input type="text" name="product_keywords" size="50" value="<?php echo $pro_keywords;?>"/></td>
                </tr>
                <tr align="center">
                    <td colspan="7"><input type="submit" name="update_product" value="تعديل بيانات المنتج"/></td>
                </tr>
            </table>
        </form>
